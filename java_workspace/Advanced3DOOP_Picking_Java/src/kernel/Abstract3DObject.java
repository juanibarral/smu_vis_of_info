...
abstract class Abstract3DObject
{
  ...
  public Abstract3DObject(PApplet _p)
  {
    ...
    pickColor = p.color(p.random(255),p.random(255),p.random(255));
    isPicking = false;
  }
  ...
  protected void processTransformations()
  {
    for(String transformation : transformations)
    {
      ...
      {
        p.translate(Float.valueOf(t[1]), Float.valueOf(t[2]), Float.valueOf(t[3]));
      }
      else if(type.equals(ROT_X))
      {
        p.rotateX(Float.valueOf(t[1]));
      }
      else if(type.equals(ROT_Y))
      {
        p.rotateY(Float.valueOf(t[1]));
      }
      else if(type.equals(ROT_Z))
      {
        p.rotateZ(Float.valueOf(t[1]));
      }
      else
      {
        p.println("Error: no transformation set");
      }
    }
  }
